export default [
  {
    ...
    rules: `Registration closes by 3rd Oct’22.
  ...
  },
  {
    ...
    rules: `Each team can consist of 2-3 members.
  ...
  },
  {
    ...
    ROUND 1: The typing duration would be for 20 seconds (per person)
    
    ROUND 2:  The typing duration would be for 40 seconds (per person) 
    
    ROUND 3: The typing duration would be for 60 seconds (per person)
     
    Note: All the text will be customized every round. The difficulty of the text and the timings will be increased each round.
     
    
    EVALUATION FOR EACH ROUND: The cumulative of wpm(words per minute), accuracy and consistency will decide the escalation of students into the next rounds. 
    `,
  ...
  },
  {
    ...
    rules: `There are two teams, each consists of four members
  ...
  },
  {
    ...
    rules: `The fate of Pandora rests with you. Colonel Quaritch is plotting against the Na'vi. It is bestowed upon you to help Jake Sully to save Pandora.
  ...
  },
  {
    ...
    rules: `It is an individual event.
